                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-4">    
                                ...
                                <select class="form-select text-capitalize" v-model="employee.departmentId" aria-label="Default select example">
                        ...
                        <div class="col-6">
                            <div class="mb-4">    
                                <label for="role" class="form-label">Role</label>
                                    <select class="form-select" v-model="employee.role" aria-label="Default select example">
                                    <option value="" selected disabled>Select</option>
                        ...
                        <div class="col-12">
                            <div>    
                                <button class="btn btn-primary" @click.prevent="handleUpdate()">Update</button>
                            </div>
...
export default{
    ...
    methods: {
        ...
        handleUpdate() {
            ...
            ApiService.patch('/employees/'+this.$route.params.id, this.employee)
            .then((resp) => {
                this.employee = {
                    name:'',
                    address:'',
